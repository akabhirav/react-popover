...
var Popover = function (_React$Component) {
  ...
  function Popover(props) {
    ...
    _this.checkForOuterMovement = function (event) {
      var isOuterMovement = !_this.containerEl.contains(event.target) && !_this.targetEl.contains(event.target);
      if (isOuterMovement) _this.props.onOuterMovement(event);
    };
  ...
  _createClass(Popover, [{
    ...
    value: function trackPopover() {
      ...
      _platform2.default.document.addEventListener("mouseenter", this.checkForOuterMovement);
      _platform2.default.document.addEventListener("mouseover", this.checkForOuterMovement);
    ...
    value: function untrackPopover() {
      ...
      _platform2.default.document.removeEventListener("mouseenter", this.checkForOuterMovement);
      _platform2.default.document.removeEventListener("mouseover", this.checkForOuterMovement);
...
Popover.propTypes = {
  ...
  onOuterMovement: _propTypes2.default.func
};
Popover.defaultProps = {
  ...
  onOuterMovement: _utils2.default.noop,
